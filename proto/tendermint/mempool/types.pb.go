...
type Txs struct {
	...
	SentPeers []string `protobuf:"bytes,2,rep,name=sent_peers,json=sentPeers,proto3" json:"sent_peers,omitempty"`
}
...
func (m *Txs) GetSentPeers() []string {
	if m != nil {
		return m.SentPeers
	}
	return nil
...
var fileDescriptor_2af51926fdbcbc05 = []byte{
	...
	0xe5, 0x95, 0xcc, 0xb8, 0x98, 0x43, 0x2a, 0x8a, 0x85, 0x04, 0xb8, 0x98, 0x4b, 0x2a, 0x8a, 0x25,
	0x18, 0x15, 0x98, 0x35, 0x78, 0x82, 0x40, 0x4c, 0x21, 0x59, 0x2e, 0xae, 0xe2, 0xd4, 0xbc, 0x92,
	0xf8, 0x82, 0xd4, 0xd4, 0xa2, 0x62, 0x09, 0x26, 0x05, 0x66, 0x0d, 0xce, 0x20, 0x4e, 0x90, 0x48,
	0x00, 0x48, 0x40, 0xc9, 0x96, 0x8b, 0xdd, 0x37, 0xb5, 0xb8, 0x38, 0x31, 0x3d, 0x55, 0x48, 0x1b,
	0xa6, 0x97, 0x51, 0x83, 0xdb, 0x48, 0x5c, 0x0f, 0xd3, 0x12, 0xbd, 0x90, 0x8a, 0x62, 0x0f, 0x06,
	0xb0, 0xb1, 0x4e, 0xac, 0x5c, 0xcc, 0xc5, 0xa5, 0xb9, 0x4e, 0xfe, 0x27, 0x1e, 0xc9, 0x31, 0x5e,
	...
	0xab, 0x9f, 0x9c, 0x9f, 0x9b, 0x5a, 0x92, 0x94, 0x56, 0x82, 0x60, 0x80, 0x3d, 0xa2, 0x8f, 0xe9,
	0xcf, 0x24, 0x36, 0xb0, 0x8c, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x43, 0xf9, 0x18, 0xe4, 0x04,
	0x01, 0x00, 0x00,
}
...
func (m *Txs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SentPeers) > 0 {
		for iNdEx := len(m.SentPeers) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SentPeers[iNdEx])
			copy(dAtA[i:], m.SentPeers[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.SentPeers[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *Txs) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SentPeers", wireType)
			}
			...
			m.SentPeers = append(m.SentPeers, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
