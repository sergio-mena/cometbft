...
type Message struct {
	...
	SentTo []string      `protobuf:"bytes,2,rep,name=sent_to,json=sentTo,proto3" json:"sent_to,omitempty"`
}
...
func (m *Message) GetSentTo() []string {
	if m != nil {
		return m.SentTo
	}
	return nil
...
var fileDescriptor_2af51926fdbcbc05 = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.SentTo) > 0 {
		for iNdEx := len(m.SentTo) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SentTo[iNdEx])
			copy(dAtA[i:], m.SentTo[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.SentTo[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.SentTo = append(m.SentTo, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
